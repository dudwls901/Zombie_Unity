...
public class LaserItem : MonoBehaviour, IItem
{
    ...
    public void Use(GameObject target)
    {
        ...
        if (playerShooter != null && playerShooter.LaserGun != null)
        {
            // 총의 남은 탄환 수를 ammo 만큼 더한다
            playerShooter.LaserGun.magAmmo += ammo;
            //플레이어가 가지고 있는 LaserGun을 활성화 시킨다.
            playerShooter.LaserGun.missileGun.SetActive(true);
